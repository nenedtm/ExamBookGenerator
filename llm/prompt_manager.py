...
_DEPTH_MAP: dict[tuple[int, int], str] = {
    ...
    (9, 10): (
        ...
        "- Use > **Example** blockquotes for illustrative examples.\n"
        "- Use > **Note** blockquotes for important caveats.\n"
...
def build_chapter_prompt(
    ...
    if depth_level >= 9:
        depth_template = (
            ...
            "[Use > **Example** blockquotes for illustrations.]\n"
            "[Use > **Note** blockquotes for caveats.]\n\n"
